...
class CalculatorTests {
    ...
    fun calculate_20_percent_tip() {
        ...
        onView(withId(R.id.tip_result))
            .check(matches(withText("Gorjeta: R\$ 10,00")))
    }
    ...
    fun calculate_18_percent_tip() {
        ...
        onView(withId(R.id.calculate_button))
            .perform(click())
        onView(withId(R.id.tip_result))
            .check(matches(withText(containsString("Gorjeta: R\$ 9,00"))))
    }
    ...
    fun calculate_15_percent_tip_round_up() {
        ...
        onView(withId(R.id.calculate_button))
            .perform(click())
        onView(withId(R.id.tip_result))
            .check(matches(withText(containsString("Gorjeta: R\$ 8,00"))))
    }
    ...
    fun calculate_15_percent_tip_no_rounding() {
        ...
        onView(withId(R.id.calculate_button))
            .perform(click())
        onView(withId(R.id.tip_result))
            .check(matches(withText(containsString("Gorjeta: R\$ 7,50"))))
    }
}